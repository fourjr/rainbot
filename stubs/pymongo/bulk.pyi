...
class _Bulk(object):
    def __init__(
        self, collection: Collection, ordered: bool, bypass_document_validation: bool
    ) -> None: ...
    ...
    def add_delete(
        self, selector: Dict[str, Any], limit: int, collation: Optional[Collation] = ...
    ) -> None: ...
    def gen_ordered(self) -> _Run: ...
    def gen_unordered(self) -> _Run: ...
    def execute_command(
        self, sock_info: SocketInfo, generator: Iterator[_Run], write_concern: WriteConcern
    ) -> Dict[str, Any]: ...
...
class BulkOperationBuilder(object):
    ...
    def find(
        self, selector: Dict[str, Any], collation: Optional[Collation] = ...
    ) -> BulkWriteOperation: ...
