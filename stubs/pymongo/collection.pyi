...
class Collection(BaseObject):
    ...
    def parallel_scan(
        self, num_cursors: int, session: Optional[ClientSession] = ..., **kwargs: Any
    ) -> List[CommandCursor]: ...
    ...
    def count_documents(
        self, filter: Mapping[str, Any], session: Optional[ClientSession] = ..., **kwargs: Any
    ) -> int: ...
    def create_indexes(
    ...
    def rename(
        self, new_name: str, session: Optional[ClientSession] = ..., **kwargs: Any
    ) -> None: ...
    def distinct(
        self,
        key: str,
    ...
    def remove(
        self, spec_or_id: Optional[Mapping[str, Any]] = ..., multi: bool = ..., **kwargs: Any
    ) -> Dict[str, Any]: ...
    def find_and_modify(
        self,
