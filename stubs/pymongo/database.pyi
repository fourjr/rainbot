...
class Database(common.BaseObject):
    ...
    def list_collections(
        self, session: Optional[ClientSession] = ..., **kwargs: Any
    ) -> CommandCursor: ...
    def list_collection_names(self, session: Optional[ClientSession] = ...) -> List[str]: ...
    def collection_names(
        self, include_system_collections: bool = ..., session: Optional[ClientSession] = ...
    ) -> List[str]: ...
    def drop_collection(
    ...
    def current_op(
        self, include_all: bool = ..., session: Optional[ClientSession] = ...
    ) -> Dict[str, Any]: ...
    def profiling_level(self, session: Optional[ClientSession] = ...) -> int: ...
    def set_profiling_level(
        self, level: int, slow_ms: Optional[int] = ..., session: Optional[ClientSession] = ...
    ) -> None: ...
    ...
    def dereference(
        self, dbref: DBRef, session: Optional[ClientSession] = ..., **kwargs: Any
    ) -> Dict[str, Any]: ...
