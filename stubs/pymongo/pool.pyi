...
class SocketInfo(object):
    def __init__(
        self, sock: socket, pool: Pool, ismaster: IsMaster, address: Tuple[str, int]
    ) -> None: ...
    def command(
        self,
        dbname: str,
    ...
    def legacy_write(
        self, request_id: int, msg: bytes, max_doc_size: int, with_last_error: bool
    ) -> Dict[str, Any]: ...
...
class Pool:
    def __init__(
        self, address: Tuple[str, int], options: PoolOptions, handshake: bool = ...
    ) -> None: ...
    def reset(self) -> None: ...
