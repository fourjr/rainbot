...
class _ServerMode(object):
    def __init__(
        self,
        mode: int,
        tag_sets: Optional[Sequence[Mapping[str, Any]]] = ...,
        max_staleness: int = ...,
    ) -> None: ...
    @property
    def name(self) -> str: ...
    ...
    def __setstate__(
        self, value: Mapping[str, Union[int, Sequence[Mapping[Any, Any]]]]
    ) -> None: ...
...
class PrimaryPreferred(_ServerMode):
    def __init__(
        self, tag_sets: Optional[Sequence[Mapping[str, Any]]] = ..., max_staleness: int = ...
    ) -> None: ...
...
def make_read_preference(
    mode: int, tag_sets: Sequence[Mapping[str, Any]], max_staleness: int = ...
) -> _ServerMode: ...
